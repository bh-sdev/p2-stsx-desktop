...
import {
  ...
  loadRefStatuses,
} from 'api/api.recall.delete.records';
...
const Filters = ({
  ...
  const browse = ({ HideEmptyColumns }) => {
    addHistoryLink({
      title: t('sts.txt.job.piecemark.recall'),
      path: `${window.origin}/${ROUTER_PATH.jobPiecemarkRecall}/${loadedInfo.ID}?hideEmptyCols=${
        HideEmptyColumns || ''
      }`,
      ...
      <div className="flex-auto flex flex-column disabled">
        ...
        <div className="flex justify-content-end gap-2 mt-3 mb-2">
          ...
          <Button
            ...
            label={t('sts.btn.record.selection.recall')}
            size="small"
